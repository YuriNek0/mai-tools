...
Install [install-mai-tools.user.js](https://yurinek0.github.io/mai-tools/install-mai-tools.user.js) with Tampermonkey or another userscript manager. The tools will then load automatically on maimai DX NET pages.
...
2. Edit the bookmark and replace its URL with:
       ...
       javascript:(function(d){var s=d.createElement('script');s.src='https://yurinek0.github.io/mai-tools/scripts/all-in-one.js?t='+Math.floor(Date.now()/60000);d.body.append(s)})(document)
